...
import { HomeIcon, CalendarIcon, LightBulbIcon,BanknotesIcon } from '@heroicons/react/24/outline';
...
const links = [
  ...
  { name: 'Monthly Planner', href: '/dashboard/planner', icon: CalendarIcon },
  { name: 'Opportunities', href: '/dashboard/opportunities', icon: LightBulbIcon },
